...
- **Global scope**: `/Users/happy/projects/revolve/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/happy/projects/revolve/.claude/notes/`)
...
2. Glob `/Users/happy/projects/revolve/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/happy/projects/revolve/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/happy/projects/revolve/.claude/notes/` — works in any directory
